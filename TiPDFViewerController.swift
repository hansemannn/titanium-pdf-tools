...
class TiPDFViewerController: UIViewController {
    var pdfView: PDFView!
    ...
    func openPDF(at url: URL, pageNumber: Int, title: String?) {
        if let document = PDFDocument(url: url) {
            ...
            self.title = title ?? fileTitle ?? url.deletingPathExtension().lastPathComponent
